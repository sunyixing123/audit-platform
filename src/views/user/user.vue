<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form>
        <el-form-item>
          <el-button type="primary" icon="plus" v-permission="'user:add'" @click="showCreate" size="small">添加
          </el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus==='create'" type="success" @click="createUser" size="small">创 建</el-button>
        <el-button type="primary" v-else @click="updateUser" size="small">修 改</el-button>
      </div>
    </el-dialog>
  </div>
</template>
